...
def plot_fits(file_list, logSpace, radiusScale, planet=60, lBoundary=30, uBoundary=400):
    """
    INPUTS:
    --------
    ...
    for i in range(len(file_list)):
        ...
        plt.plot(length[lBoundary:uBoundary]*1/scale, intensity_profile, label=filename)
